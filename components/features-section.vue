  ...
  <section id="features" class="bg-[#FAFAFA] rounded-4 overflow-clip sm:min-h-50em relative">
    <div class="flex flex-col gap-6 sm:gap-0 sm:flex-row justify-between sm:space-x-8 p-4 pt-8 sm:py-12 sm:px-8">
      <div class="sm:w-1/3 sm:p-6 rounded-lg flex items-start sm:justify-center">
        ...
        <div>
          <h2 class="text-4 sm:text-xl font-medium mb-2 line-height-4">Curved or Shaped</h2>
          <p class="text-gray-600 text-3 sm:text-4.2">Style Your Titles with Custom Border Radius</p>
        </div>
      </div>
      ...
      <div class="sm:w-1/3 sm:p-6 rounded-lg flex items-start sm:justify-center">
        ...
        <div>
          ...
          <p class="text-gray-600 text-3 sm:text-4.2">Personalize your headings with borders that match your mood</p>
        </div>
      </div>
      ...
      <div class="sm:w-1/3 sm:p-6 rounded-lg flex items-start sm:justify-center">
        ...
        <div>
          ...
          <p class="text-gray-600 text-3 sm:text-4.2">Align your headings in the center for a clean look</p>
        </div>
      </div>
    </div>
