<template>
  <section class="text-center py-12">
    ...
    <UButton to="https://cutt.ly/MeFLNZqu" class="bg-black hover:bg-[#1983F9] text-16px px-20px pt-10px pb-12px font-600 rounded-8px">
  ...
  <section id="features" class="bg-[#FAFAFA] rounded-4 overflow-clip min-h-50em relative">
    <div class="flex justify-between space-x-8 py-12 px-8">
      <div class="w-1/3 p-6 rounded-lg flex items-center justify-center">
        ...
        <div>
          <h2 class="text-xl font-medium mb-2 line-height-4">Curved or Shaped</h2>
          <p class="text-gray-600">Style Your Titles with Custom Border Radius</p>
        </div>
      </div>
      ...
      <div class="w-1/3 p-6 rounded-lg flex items-center justify-center">
        ...
        <div>
          <h2 class="text-xl font-medium mb-2 line-height-4">Solid or Dashed</h2>
          <p class="text-gray-600">Personalize your headings with borders that match your mood</p>
        </div>
      </div>
